...
data class RegisterData(val pendingRegistrationId: String, val email: String?, val verificationMethod: String, val otpExpiresIn: Int? = null)
data class ResendData(val pendingRegistrationId: String?, val channel: String?, val expiresIn: Int?, val retryAfter: Int?)
data class OtpRequest(val pendingRegistrationId: String? = null, val userId: String? = null, val code: String, val channel: String)
