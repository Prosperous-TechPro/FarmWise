...
const faqCategories = [
  { name: 'Account & Authentication', description: 'Registration, OTP verification, login, and password recovery.', displayOrder: 1 },
  ...
  { name: 'Workers', description: 'Workers, assignments, and permissions.', displayOrder: 5 },
  { name: 'Finance & Reports', description: 'Financial records, reporting, and operational summaries.', displayOrder: 6 },
  { name: 'Tasks & Activities', description: 'Tasks and operational activity records.', displayOrder: 7 },
  { name: 'Inventory Management', description: 'Stock, usage, and low-stock alerts.', displayOrder: 8 },
  { name: 'Expenses & Sales', description: 'Financial transactions and profit or loss.', displayOrder: 9 },
  { name: 'Reports & Analytics', description: 'Dashboards, reports, trends, and estimates.', displayOrder: 10 },
  { name: 'Notifications', description: 'Alerts and account notifications.', displayOrder: 11 },
  { name: 'Community', description: 'Community posts, comments, and reports.', displayOrder: 12 },
  { name: 'Private Messaging', description: 'Authorized private conversations.', displayOrder: 13 },
  { name: 'Security & Privacy', description: 'Access control, security, and privacy.', displayOrder: 14 },
  { name: 'FAQ & Feedback', description: 'Help content and user feedback.', displayOrder: 15 },
  { name: 'Admin & Super Admin', description: 'Administrative tools and permissions.', displayOrder: 16 },
];

const faqDefinitions = [
  ['Account & Authentication', 'How do I create a FarmWise account?', 'Select Create Account, enter the required information, choose a verification method, and complete OTP verification.'],
  ['Account & Authentication', 'What happens if I do not receive my OTP?', 'Confirm your email or phone number, check your email spam folder, and request another OTP when permitted.'],
  ['Account & Authentication', 'I forgot my password. What should I do?', 'Use Forgot Password and follow the verification and password-reset instructions.'],
  ...
  ['Workers', 'Can I control what a worker can do?', 'Yes. Farm Owners can grant or revoke appropriate worker permissions.'],
