...
const initialForm = { speciesId: '', breedId: '', breedName: '', tagNumber: '', name: '', sex: 'UNKNOWN', status: 'ACTIVE', acquisitionType: 'BORN_ON_FARM', acquisitionDate: '', dateOfBirth: '', currentWeight: '', weightUnit: 'KILOGRAM', notes: '' };
  ...
  const save = async (event) => {
    ...
    try {
      const payload = {
        ...
        breedName: form.breedName && form.breedName.trim() ? form.breedName.trim() : undefined,
        name: form.name || undefined,
        acquisitionDate: form.acquisitionDate || undefined,
        dateOfBirth: form.dateOfBirth || undefined,
        currentWeight: form.currentWeight === '' ? undefined : Number(form.currentWeight),
